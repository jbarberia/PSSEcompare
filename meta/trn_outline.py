...
read_dict = {'int':['FROMNUMBER','TONUMBER','STATUS','METERNUMBER',
        ...
        'real':['AMPS','PUCUR','PCTRATE','PCTRATEA','PCTRATEB','PCTRATEC',
            ...
            'PCTMVARATE1', 'PCTCORPRATE1', 'MAXPCTRATE1', 'MXPCTMVARAT1', 'MXPCTCRPRAT1',
            'PCTMVARATE2', 'PCTCORPRATE2', 'MAXPCTRATE2', 'MXPCTMVARAT2', 'MXPCTCRPRAT2',
            'PCTMVARATE3', 'PCTCORPRATE3', 'MAXPCTRATE3', 'MXPCTMVARAT3', 'MXPCTCRPRAT3',
            'PCTMVARATE4', 'PCTCORPRATE4', 'MAXPCTRATE4', 'MXPCTMVARAT4', 'MXPCTCRPRAT4',
            'PCTMVARATE5', 'PCTCORPRATE5', 'MAXPCTRATE5', 'MXPCTMVARAT5', 'MXPCTCRPRAT5',
            'PCTMVARATE6', 'PCTCORPRATE6', 'MAXPCTRATE6', 'MXPCTMVARAT6', 'MXPCTCRPRAT6',
            'PCTMVARATE7', 'PCTCORPRATE7', 'MAXPCTRATE7', 'MXPCTMVARAT7', 'MXPCTCRPRAT7',
            'PCTMVARATE8', 'PCTCORPRATE8', 'MAXPCTRATE8', 'MXPCTMVARAT8', 'MXPCTCRPRAT8',
            'PCTMVARATE9', 'PCTCORPRATE9', 'MAXPCTRATE9', 'MXPCTMVARAT9', 'MXPCTCRPRAT9',
            'PCTMVARATE10', 'PCTCORPRATE10', 'MAXPCTRATE10', 'MXPCTMVARAT10', 'MXPCTCRPRAT10',
            'PCTMVARATE11', 'PCTCORPRATE11', 'MAXPCTRATE11', 'MXPCTMVARAT11', 'MXPCTCRPRAT11',
            'PCTMVARATE12', 'PCTCORPRATE12', 'MAXPCTRATE12', 'MXPCTMVARAT12', 'MXPCTCRPRAT12',
